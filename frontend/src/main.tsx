...
function App() {
  ...
  const refresh = async () => { setRefreshing(true); setError(false); try { setData(await loadDashboard()) } catch { setError(true) } finally { setRefreshing(false) } }
